...
<head>
    ...
    <!-- preload images -->
    <link rel="preload" href="/assets/images/profile.png" as="image" type="image/png" />
    <!-- preload images -->
...
<body class="text-white font-rajdhani bg-black">
    <header class="fixed right-8 top-1/2 -translate-y-1/2 z-1 max-lg:hidden">
        <nav class="bg-dark-1/50 backdrop-blur-0.5xs rounded-full shadow-aside-social p-2">
            <ul class="flex flex-col gap-2 relative before:bg-white before:w-full before:aspect-square before:absolute before:rounded-full before:top-[var(--top)] before:transition-[top] duration-500 header-link-list" style="--top:0px;">
                <li>
                                    ...
                                    <div class="">
                                        <div class="py-13.5 border-dark-2/50 border-2 rounded-full">
                                            <div class="text-center">
                                                <iconify-icon class="h-18" icon="<?= $skill['icon'] ?>" width="72" height="72"></iconify-icon>
                                            </div>
                                            <div class="mt-7.5">
